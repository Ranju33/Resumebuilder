...
public class TC_Education_003Test extends Base_Class {
	...
	public void Education() {
		...
		Assert.assertEquals(download.getDownload().getText(), excelLib.readStringDataFromExcel("Sheet1",0,11),"Download not Successfully in PDF formate with different templates");
		Reporter.log("Download Successfully in PDF farmate with different templates",true);
